...
class _ScientificCalculatorState extends State<ScientificCalculator> {
  ...
  void initState() {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      ...
      statusBarColor:Color(0xff262A56), 
    ));
    initialise();
  }
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: <Widget>[
              Text('SCIENTIFIC CALCULATOR', style: TextStyle(color: Colors.cyanAccent.withOpacity(.5), fontSize: 24, fontWeight: FontWeight.bold),),
